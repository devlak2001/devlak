(() => {
    document.addEventListener('DOMContentLoaded', () => {
        if (document.querySelector('.last-notes .blog-slider')) {
            // Slider dragging
            const slider = document.querySelector('.last-notes .blog-slider');
            let sliderIndicatorElements = document.querySelectorAll('.last-notes .blog-slider-indicator .slide-indicator');
            let sliderItems = document.querySelectorAll('.last-notes .blog-slider .blog');
            let isDown = false;
            let startX;
            let scrollLeft;
